...
export class MockScreenerService implements IScreenerService {
  private mockScreener: Screener = {
    id: "abcd-123",
    name: "BPDS",
  ...
  async submitAnswers(answers: AnswerResponse[]): Promise<void> {
    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        console.log("Answers submitted to API:", answers);
        resolve();
      }, 500);
    });
  }
